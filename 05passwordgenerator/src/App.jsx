...
function App() {
  ...
  const copyPasswordToClipBoard = () => {
    ...
    // passwordReff.current?.setSelectionRange(0,4)
  }
  ...
  return (
    ...
    rounded-1g px-4 py-3 my-8 bg-gray-800 text-orange-500'>
      ...
      <div className='flex shadow rounded-lg overflow-hidden mb-4'>
        <input ref={passwordReff} type="text" value={password} className='ouline-none w-full py-1 px-3' placeholder='password' readOnly />
